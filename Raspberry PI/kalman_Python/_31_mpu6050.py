...
# Custom Imports
from _31_pycomms import PyComms
...
class MPU6050:
    ...
    MPU6050_RA_SMPLRT_DIV         = 0x19 # 1K / (rate+1): DLPF on의 경우, 8K / (rate+1): DLPF off의 경우
    ...
    def getAcceleration(self):
        ...
        # by JHK
        accel = [0] * 3
        accel[0] = self.i2c.readS16(self.MPU6050_RA_ACCEL_XOUT_H)
        accel[1] = self.i2c.readS16(self.MPU6050_RA_ACCEL_YOUT_H)
        accel[2] = self.i2c.readS16(self.MPU6050_RA_ACCEL_ZOUT_H)
        return accel
    ...
    def getRotation(self):
        ...
        # by JHK
        gyro = [0] * 3
        gyro[0] = self.i2c.readS16(self.MPU6050_RA_GYRO_XOUT_H)
        gyro[1] = self.i2c.readS16(self.MPU6050_RA_GYRO_YOUT_H)
        gyro[2] = self.i2c.readS16(self.MPU6050_RA_GYRO_ZOUT_H)
        return gyro
